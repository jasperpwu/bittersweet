...
import { fruitsForMinutes, calculateFruitsEarnedForDuration } from '../utils/fruitMath';
...
// The fruit curve itself now lives in utils/fruitMath so challenge reward math
// can reach it without importing the store (cycle). Re-exported here so the
// existing `from '../store'` call sites keep working.
export { fruitsForMinutes, calculateFruitsEarnedForDuration };
